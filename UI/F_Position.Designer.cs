...
namespace UI
{
    partial class F_Position
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblSubtitle.Text = "Quản lý danh mục Chức danh trong công ty";
            // 
            // lblTitle
            // 
            ...
            lblTitle.TabIndex = 0;
            lblTitle.Text = "👔 Quản Lý Chức Danh";
            // 
            // pnlContainer
            // 
            ...
            pnlCard.Controls.Add(dgvPositions);
            ...
            dgvPositions.ColumnHeadersHeight = 45;
            dgvPositions.Dock = DockStyle.Fill;
            dgvPositions.EnableHeadersVisualStyles = false;
            dgvPositions.GridColor = Color.FromArgb(230, 230, 230);
            dgvPositions.Location = new Point(0, 116);
            ...
            dgvPositions.Size = new Size(1050, 481);
            ...
            lblStatus.Text = "⚡ Sẵn sàng | Tổng số: 0 chức danh";
    ...
    // Reuse RoundedButton (nếu project bạn đã có class này thì không cần lặp lại)
